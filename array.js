...
// Array.isArray method check if a variable is an array or not
console.log(Array.isArray([7, 8]));

// Array.from method changes a datatype to an array
...
// delete method is use to delete an element from an array
console.log(arr);
delete arr[1];
console.log(arr);

// findIndex method wil return the position of the first element that matches a search condition
const arr2 = [5, 6, 7, 9, 13, 500, 200, 120];
